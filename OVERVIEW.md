...
| v0.3.3 | README PyPI link fixes, DataTable docs update, components guide rewrite, CONTRIBUTING Good First Issues updated | ✅ Released (PyPI: 2026-05-15) |
| v0.4.0 | Page.lang, Component.to_json(), hatch-vcs migration, Trusted Publishing workflow | ✅ Released (PyPI: 2026-05-15) |
| v0.4.1 | GitHub issue templates, PR template, CONTRIBUTING guide, release.py/push.py removal | ✅ Released (PyPI: 2026-06-16) |
...
| Date       | Change |
|------------|--------|
| 2026-06-16 | v0.4.1: Add GitHub issue templates (bug.yml, feature.yml, config.yml), PR template, updated CONTRIBUTING.md with setup/workflow/standards, remove release.py and push.py (workflow now handles releases) |
| 2026-05-20 | v0.4.0: Page.lang, Component.to_json(), hatch-vcs migration, Trusted Publishing workflow |
